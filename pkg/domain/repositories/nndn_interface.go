...
type NNDNRepository interface {
	...
	// DeleteNNDN removes an NNDN by name, within scope; out of scope reads as not found.
	DeleteNNDN(ctx context.Context, scope entities.RegistryScope, name string) error
