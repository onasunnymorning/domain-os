...
export const STATUS_DESCRIPTIONS: Record<string, string> = {
  ...
  ClientDeleteProhibited: "Registrar blocks delete operations; this will also prevent the domain from dropping.",
  ...
  ServerDeleteProhibited: "Registry blocks delete operations; this will also prevent the domain from dropping.",
