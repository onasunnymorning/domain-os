<a name="unreleased"></a>
## [0.9.0](https://github.com/onasunnymorning/domain-os/compare/v0.8.4...v0.9.0) (2026-09-21)


### Features

* confine registry deletes to the operator that runs the TLD ([#415](https://github.com/onasunnymorning/domain-os/issues/415), INV-02) ([a72a9a5](https://github.com/onasunnymorning/domain-os/commit/a72a9a57b4f7461024d775c3f9f5228d7570da0a))
* confine registry deletes to the operator that runs the TLD ([#415](https://github.com/onasunnymorning/domain-os/issues/415)) ([2754504](https://github.com/onasunnymorning/domain-os/commit/2754504c0f12adebe6de08a1f0be9f0b217b42cf))
* **db:** constrain a domain or NNDN name to the TLD it is filed under ([#415](https://github.com/onasunnymorning/domain-os/issues/415)) ([30ae8d8](https://github.com/onasunnymorning/domain-os/commit/30ae8d8f0350b8d2c3832baaa4d69f0db270a77a))
...
* **entities:** require a domain or NNDN to name the TLD it is filed under ([#415](https://github.com/onasunnymorning/domain-os/issues/415)) ([078d6f9](https://github.com/onasunnymorning/domain-os/commit/078d6f9f8c374c651759670b0c0d659e4187bf48))
* **escrow:** align the language an operator reads, and draw the deposit ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([640ee61](https://github.com/onasunnymorning/domain-os/commit/640ee613ad2b0fe86c88f272e020c77925f921e4))
* **escrow:** name sanitized derivatives after their suffix and watermark ([021ab70](https://github.com/onasunnymorning/domain-os/commit/021ab70d3c4a5c001da5901db1fc1cb0636947af))
* **escrow:** name sanitized derivatives after their suffix and watermark ([1f715f2](https://github.com/onasunnymorning/domain-os/commit/1f715f2878416f293d48063b4b7aa80eb4ad6348))
* **escrow:** overview card at the top of the validation run page ([aca3859](https://github.com/onasunnymorning/domain-os/commit/aca38599221692a531b44d7567796ab9fb278c7a))
* **escrow:** overview card at the top of the validation run page ([b8f386c](https://github.com/onasunnymorning/domain-os/commit/b8f386cecf1136e9d573ecf7168f257f59233724))
* **escrow:** say verification key and receiving identity where an operator reads it ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([177e49a](https://github.com/onasunnymorning/domain-os/commit/177e49aa6fe35c3bffdf8c4065239925465d9098))
* **escrow:** tag NNDNs imported from a deposit with reason RDE-import ([0f51e23](https://github.com/onasunnymorning/domain-os/commit/0f51e23c9d648ee1047b1d91da6f98b97d53f972))
* **escrow:** tag NNDNs imported from a deposit with reason RDE-import ([a3cd892](https://github.com/onasunnymorning/domain-os/commit/a3cd89254a36bb93d6a2c19039a72eef7e8af5b3))
...
* **eve:** escrow key registry — parties, key versions, arrangements ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([06ab9ab](https://github.com/onasunnymorning/domain-os/commit/06ab9ab61d48a1c5a811c05b4851eadf4ebf799e))
* **eve:** escrow key registry — parties, key versions, arrangements ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([165ed8f](https://github.com/onasunnymorning/domain-os/commit/165ed8f37d9b786b20548f9f361ce8140282784a))
...
* **jisc:** gate the direct import on a pure-read QA report before any Postgres write ([907d2cf](https://github.com/onasunnymorning/domain-os/commit/907d2cf5165a5323d314e91e0115db42abd4ec0f))
* make cross-TLD contamination structurally impossible ([#415](https://github.com/onasunnymorning/domain-os/issues/415)) ([37c11fc](https://github.com/onasunnymorning/domain-os/commit/37c11fc6eaf6e2ba0e72d16d5e10a4865842aa99))
* **repo:** guard domain, NNDN and phase updates with their TLD ([#415](https://github.com/onasunnymorning/domain-os/issues/415)) ([01c1830](https://github.com/onasunnymorning/domain-os/commit/01c183009cc23b84cb22bd7a97695026fe56f9fd))
...
* **ui:** draw the escrow deposit instead of describing it ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([4815ac9](https://github.com/onasunnymorning/domain-os/commit/4815ac9c4cf81e14031d517da6e7196ba4d576cb))
* **ui:** escrow configuration in the direction deposits travel ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([93c4978](https://github.com/onasunnymorning/domain-os/commit/93c497885ee2d79b9196e7627881452f2a90d9d5))
* **ui:** make the profile element visible in every auth state ([fee23c4](https://github.com/onasunnymorning/domain-os/commit/fee23c4eb08d55c66cb9cb8b3931ad3c635fe7d5))
* **ui:** make the profile element visible in every auth state ([38fa6fc](https://github.com/onasunnymorning/domain-os/commit/38fa6fc6a5fa8e7395852711d73d1102cdc6ac78))
* **ui:** say who sends escrow deposits, and whether it works ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([65f21e5](https://github.com/onasunnymorning/domain-os/commit/65f21e5e9e4c68d815e5c30927aa535653e5b735))
...
* **entities:** keep "." out of generated authInfo so NewContact cannot reject it ([b2194d9](https://github.com/onasunnymorning/domain-os/commit/b2194d966eaf03af0e8b0a26b82c4b6a406a556b))
* **escrow:** generate a random authInfo on import instead of stamping a shared constant ([8dd39c2](https://github.com/onasunnymorning/domain-os/commit/8dd39c225225453eb52247059f30670a467b5fce))
* **escrow:** generate a random authInfo on import instead of stamping a shared constant ([6015e6d](https://github.com/onasunnymorning/domain-os/commit/6015e6db59b230c5a06370190e5e60f2998fde6f))
...
* **escrow:** reopen a sanitization run that ended in ERROR instead of replaying it ([db5d799](https://github.com/onasunnymorning/domain-os/commit/db5d79976f09ff245df029efd60cc682673f6386))
* **escrow:** reopen a sanitization run that ended in ERROR instead of replaying it ([#415](https://github.com/onasunnymorning/domain-os/issues/415)) ([e1abd0e](https://github.com/onasunnymorning/domain-os/commit/e1abd0e34fb12ce821b9fb0e669ed0da2d330e79))
* **escrow:** stop an import re-tagging another TLD's domains ([6e541c3](https://github.com/onasunnymorning/domain-os/commit/6e541c337adfc4c36df5ac7bd3037e3066808b32))
* **escrow:** stop an import re-tagging another TLD's domains, and stop sanitize replaying a different suffix ([#415](https://github.com/onasunnymorning/domain-os/issues/415)) ([f0e8fa6](https://github.com/onasunnymorning/domain-os/commit/f0e8fa674efe9609f2e88b6fb9892de04b0a459c))
...
* **eve:** accept a registry key whose subkeys cannot be read ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([6523621](https://github.com/onasunnymorning/domain-os/commit/6523621549b9ecef162f36d0db602f12f94ae428))
* **eve:** accept a registry key whose subkeys cannot be read ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([9fabcf6](https://github.com/onasunnymorning/domain-os/commit/9fabcf6a45ef680255c0e3f89423b14d627ac214))
...
* **eve:** let the escrow key registry work with Auth0 disabled ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([90b6187](https://github.com/onasunnymorning/domain-os/commit/90b618730e3fa4b2158d6d26d5deea6967d37035))
* **eve:** let the escrow key registry work with Auth0 disabled ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([702d53d](https://github.com/onasunnymorning/domain-os/commit/702d53d8bcba4df210f7f910a1877e10a0bc4967))
* **eve:** never drop a subkey that could sign, and say which key signed ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([98264b8](https://github.com/onasunnymorning/domain-os/commit/98264b878381fd7cabcc1e5df7abd623fbe7a312))
* **eve:** never drop a subkey that could sign, and say which key signed ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([195b117](https://github.com/onasunnymorning/domain-os/commit/195b117c984347fd59d209ec5fa55de8fa4853e2))
...
* **eve:** say why a registry key was refused, and keep the paste ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([5c734ea](https://github.com/onasunnymorning/domain-os/commit/5c734eaa31b8bdf27b785418727ac4f6c04f8297))
* **eve:** say why a registry key was refused, and keep the paste ([#429](https://github.com/onasunnymorning/domain-os/issues/429)) ([491f4a2](https://github.com/onasunnymorning/domain-os/commit/491f4a2869546a860294ec686274152066300db3))
...
* **jisc:** stop ImportToAdminAPI stamping a shared authInfo, and publish the QA report under its standard name ([db9d8c4](https://github.com/onasunnymorning/domain-os/commit/db9d8c4de05aa3ffeda923d9fb83b2c240061dfa))
* **lint:** annotate the domains_within_tld sample query for gosec G202 ([44b7f9f](https://github.com/onasunnymorning/domain-os/commit/44b7f9fddde8d98d8542d048c2692c5ba5e3b52b))
...
* **tlds:** rank accredited registrars by TLD-scoped DUMs, not one page of them ([621a113](https://github.com/onasunnymorning/domain-os/commit/621a1138ed1d5e31aadb7be2659be09d2a6e6b93))
* **tlds:** rank accredited registrars by TLD-scoped DUMs, not one page of them ([b4b40db](https://github.com/onasunnymorning/domain-os/commit/b4b40dbaa16ca1d4c4fe54bf22013516e6bbd550))
...
* **ui:** open the workflow window on the workflow that was just launched ([7b20efb](https://github.com/onasunnymorning/domain-os/commit/7b20efba215b5694a7054b7171b9b8f792ed18c7))
* **ui:** open the workflow window on the workflow that was just launched ([f112ebc](https://github.com/onasunnymorning/domain-os/commit/f112ebc55977054015ae4b1c61a5531eccbb9142))
