...
<!-- The Grafana Cloud access-policy token used below.
     A live token was pasted here in Feb 2025 and sat in this public repo until
     Aug 2026 (#411). It has been redacted; the value belongs in the secret
     store, not in a README. Export it before running the helm command:

       export GRAFANA_CLOUD_TOKEN="$(doppler secrets get GRAFANA_CLOUD_TOKEN --plain)"
-->
