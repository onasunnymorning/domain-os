...
// RoIDMapping maps the RoID from the escrow deposit to the new RoID generated by the system
type RoIDMapping map[string]RoidType

// NewRoIDMapping creates a new, empty RoIDMapping
func NewRoIDMapping() RoIDMapping {
	return make(RoIDMapping)
}
