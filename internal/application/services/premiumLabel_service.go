...
func (pls *PremiumLabelService) ListLabels(ctx context.Context, pagesize int, cursor string) ([]*entities.PremiumLabel, error) {
	return pls.labelRepo.List(ctx, pagesize, cursor)
}
