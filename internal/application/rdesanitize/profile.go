...
func baselineElements() map[string]Action {
	m := map[string]Action{
		...
		"rdeContact:postalInfo>contact:name": synthName,
		"rdeContact:postalInfo>contact:org":  drop,
		"rdeContact:postalInfo>contact:addr": keep,
		"contact:addr>contact:street":        drop,
		"contact:addr>contact:city":          keep,
		"contact:addr>contact:sp":            keep,
		"contact:addr>contact:pc":            keep,
		"contact:addr>contact:cc":            keep,
		"rdeContact:voice":                   drop,
		"rdeContact:fax":                     drop,
		"rdeContact:email":                   synthEmail,
		// disclosure preferences are empty flag elements, not values: they share
		// their names with the postal fields and must not share their decisions
		"rdeContact:disclose>contact:name":  keep,
		"rdeContact:disclose>contact:org":   keep,
		"rdeContact:disclose>contact:addr":  keep,
		"rdeContact:disclose>contact:voice": keep,
		"rdeContact:disclose>contact:fax":   keep,
		"rdeContact:disclose>contact:email": keep,
...
func baselineAttributes() map[string][]string {
	return map[string][]string{
		...
		"rdeContact:voice":                 {"x"},
		"rdeContact:fax":                   {"x"},
		"rdeContact:disclose>contact:name": {"type"},
		"rdeContact:disclose>contact:org":  {"type"},
