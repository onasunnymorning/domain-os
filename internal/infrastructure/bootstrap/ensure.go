	...
	return []scheduleSpec{
		{
			...
			Note:          "Expires domains hourly — managed by dominos bootstrap",
		},
		{
			...
			CatchupWindow: time.Hour,
			Note:          "Purges redeemed domains hourly — managed by dominos bootstrap",
		},
		{
			...
			CatchupWindow: time.Hour,
			Note:          "Restores domains hourly — managed by dominos bootstrap",
		},
		{
			...
			Note:          "Syncs registrars with IANA daily — managed by dominos bootstrap",
		},
		{
			...
			Offset:        30 * time.Minute,
			CatchupWindow: time.Hour,
			Note:          "Updates FX rates hourly — managed by dominos bootstrap",
		},
	}
}
